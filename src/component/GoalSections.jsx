...
const goals = [
  ...
  },
  {
    ...
    desc: "job opportunity for skilled workers like nurses, drivers , technicians",
  },
];
  ...
  return (
    <div className="bg-blue-300 py-16 px-4" id="goals">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-gray-600 mt-3 max-w-2xl mx-auto font-bold">
          Whether you're a student, professional, or enthusiast, our courses are
        ...
        <div className="mt-14">
          <div className="bg-gradient-to-r from-indigo-700 to-[#D33A3D] text-white rounded-xl py-8 px-6 max-w-4xl mx-auto">
            ...
            <p className="text-sm mt-2 opacity-90">
              ...
              resume, opening doors to better job opportunities in multinational
